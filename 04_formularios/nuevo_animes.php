    ...
    <div class="container">
        <?php
            if ($_SERVER["REQUEST_METHOD"] == "POST") {                
                ...
                /*titulo: Es obligatorio y tendrá como máximo 80 caracteres. Admite cualquier tipo de carácter.*//*patron?*/
                ...
                /*Patrón no necesario: En este caso, no se usa un patrón porque el título 
                permite cualquier tipo de carácter (letras, números, símbolos). Solo se limita la longitud, por lo que strlen es suficiente*/



                /*nombre_estudio: Es obligatorio y se elegirá mediante un campo de tipo select.
                 Para crear este select primero haremos un array unidimensional con nombres de estudios de anime
                  (al menos 5, puedes coger los nombres de la base de datos).
                   Los option del select se crearán de manera dinámica en un bucle recorriendo dicho array
                    y creando un option por cada valor del mismo. */

                    /*Patrón no necesario: No se usa un patrón porque la lista de opciones es predefinida,
                     y la validación se realiza a través de la comparación con el array de valores permitidos (in_array).*/
               
                // Validación de nombre_estudio usando isset()
                ...
                if (isset($_POST["nombre_estudio"])) {
                    ...
                    if (in_array($tmp_nombre_estudio, $array_estudios)) {
                        ...
                        $err_nombre_estudio = "Elige un estudio válido.";
                    }
                } else {
            ...
            Sólo aceptará valores numéricos entre 1960 y dentro de 5 años (inclusive).*/     
                if ($tmp_anno_estreno != '') {
                    $patron = "/^[0-9]{4}$/";

...
<body>
    ...
    <?php
    //El metodo get cada ves que se recarga la pagina web se  activar. Si se va a ejecutar siempre, no hace falta poner requestmethod  que es lo que usabamos con post....
    ...
    if ((isset($_GET["precio"])) && (isset($_GET["iva"]))) {
        //Aqui solo entra si se le da al boton, haya o no datos. 
        //no sirve es la pagina se recargo
        $iva = $_GET["iva"];
        $precio = $_GET["precio"];
